...
router.get('/', (req, res) => {
    ...
    con.query("SELECT * FROM kalo_db.usuario;", (error, results) =>{
        if(error){
            throw error
        }else{
...
router.get('/edit/:id', (req, res) =>{
    ...
    con.query('SELECT * FROM kalo_db.usuario WHERE ID_USUARIO = ?;', [id], (error, results) =>{
        if(error){
            throw error
        }else{
...
router.get('/delete/:id', (req, res) => {
    ...
    const id = req.params.id
    con.query('DELETE FROM kalo_db.usuario WHERE ID_USUARIO = ?;', [id], (error, results) =>{
        if(error){
            throw error
        }else{
            res.redirect('/');
